...
### 1.1 Product description
 WB02B-8684H2V1 is a low power consumption embedded (2.4 GHz Wi­Fi) and Bluetooth 5 (LE) IOT dual-mode module. It consists of a highly integrated radio frequency (RF) wireless core, the ESP8684, and the WB02B-8684H2V1.
